...
public class CodeGenerator2 {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:/workspace-sts/0520adv/0520Bills/src/main/java");
        gc.setAuthor("老雷");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/bills?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
...
//        pc.setModuleName(scanner("模块名"));
        ...
        pc.setParent("com.sxt");//controller entity  service  service.impl
