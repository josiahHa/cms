package com.zjh.cms.system.common.CodeGenerator;
...
//        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setOutputDir("F:\\learning\\spring boot\\workspace\\cms\\src\\main\\java");
        gc.setAuthor("老雷");
        ...
        dsc.setUrl("jdbc:mysql://47.93.54.242:3306/erp?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC");
        // dsc.setSchemaName("public");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("zjhuang");
...
//        pc.setModuleName("sys");
        pc.setParent("com.zjh.cms");//controller entity  service  service.impl
