package com.zjh.cms.system.cache;
...
public class CacheAspect {
	...
	// 声明切面表达式
	private static final String POINTCUT_DEPT_ADD = "execution(* com.zjh.cms.system.service.impl.DeptServiceImpl.save(..))";
	private static final String POINTCUT_DEPT_UPDATE = "execution(* com.zjh.cms.system.service.impl.DeptServiceImpl.updateById(..))";
	private static final String POINTCUT_DEPT_GET = "execution(* com.zjh.cms.system.service.impl.DeptServiceImpl.getById(..))";
	private static final String POINTCUT_DEPT_DELETE = "execution(* com.zjh.cms.system.service.impl.DeptServiceImpl.removeById(..))";
